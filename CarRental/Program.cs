using CarRental.Library.Manager;
...
try
{
    ...
    builder.Services.AddScoped<ICarImageGalleryService, CarImageGalleryManager>();
    builder.Services.AddScoped<ICarService, CarManager>();
    builder.Services.AddScoped<IContactService, ContactManager>();
    builder.Services.AddScoped<IHomeService, HomeManager>();
    builder.Services.AddScoped<IQuickLinkService, QuickLinkManager>();
    builder.Services.AddScoped<IReservationService, ReservationManager>();
    builder.Services.AddScoped<ISettingService, SettingManager>();
    builder.Services.AddScoped<ISliderService, SliderManager>();
    builder.Services.AddScoped<ISubsNewsletterService, SubsNewsletterManager>();
